...
public class CalculateFunction extends Thread {
    ...
    public CalculateFunction(Calcu2 calcu2, File[] initialFiles, int outMode, int fireMaxNum, int maxDiff) {
        this.progressBar = calcu2.progressBar;
        this.text = calcu2.text;
        this.textArea = calcu2.textArea;
        this.finish = calcu2.finish;
